...
describe('resolveAnchorIdl', () => {
    ...
    test('throws IdlDecodeError(bytes) when present account is not decompressible', async () => {
        const garbage = Buffer.alloc(80);
        garbage.writeUInt32LE(20, 40); // claims 20 bytes of payload, but it isn't valid zlib
